#!/usr/bin/env groovy
/*
 * semanticcms-news-bom - Bill of Materials (BOM) for SemanticCMS News features.
 * Copyright (C) 2021, 2022, 2023  AO Industries, Inc.
 *     support@aoindustries.com
 *     7262 Bull Pen Cir
 *     Mobile, AL 36695
 *
 * This file is part of semanticcms-news-bom.
 *
 * semanticcms-news-bom is free software: you can redistribute it and/or modify
 * it under the terms of the GNU Lesser General Public License as published by
 * the Free Software Foundation, either version 3 of the License, or
 * (at your option) any later version.
 *
 * semanticcms-news-bom is distributed in the hope that it will be useful,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
 * GNU Lesser General Public License for more details.
 *
 * You should have received a copy of the GNU Lesser General Public License
 * along with semanticcms-news-bom.  If not, see <https://www.gnu.org/licenses/>.
 */
...
def upstreamProjects = [
  ...
  // BOM
  'all', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-news-all</artifactId>
  'model', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-news-model</artifactId>
  'rss', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-news-rss</artifactId>
  'servlet', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-news-servlet</artifactId>
  'style', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-news-style</artifactId>
